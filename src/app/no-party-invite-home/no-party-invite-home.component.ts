...
@Component({
  selector: 'app-no-party-invite-home',
  templateUrl: './no-party-invite-home.component.html',
  styleUrls: ['./no-party-invite-home.component.scss']
})
export class NoPartyInviteHomeComponent implements OnInit {
  currentDate:any;
  targetDate:any;
  cDateMillisecs:any;
  tDateMillisecs:any;
